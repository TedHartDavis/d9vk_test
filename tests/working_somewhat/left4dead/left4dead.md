...
From cmd.exe:
left4dead.exe -steam -w 1920 -h 1080 -windowed -noborder +mat_disable_d3d9ex 1 +mat_d3d9ex_disabled 1 -dxlevel 90 +mat_dxlevel 90

Symptoms:
Doesn't really render 3D stuff

Remarks:
See log
See video:
https://youtu.be/5WxqU09c8-0


Video:

[Barely working 3D] D9VK Left 4 Dead [Date]
...
Tags:
Joshua, Ashton, DirectX, D9VK, Vulkan, Open Source, Left 4 Dead, Half-Life 2 Engine, Github, DXUP
